            ...
            <div className="card">
                ...
                <form className="sm:text-lg text-base" onSubmit={onSubmit}>
                    <div className="flex flex-col mb-4">
                        ...
                        <input type="text" required className="form-input" ref={usernameRef}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label>Email</label>
                        <input type="email" required className="form-input" ref={emailRef}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label>Password</label>
                        <input type="password" required className="form-input" ref={passwordRef}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label>Confirm Password</label>
                        <input type="password" required className="form-input" ref={confirmPWRef}/>
                    </div>
