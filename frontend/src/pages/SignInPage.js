            ...
            <div className="card">
                ...
                <form className="sm:text-lg text-base" onSubmit={onSubmit}>
                    <div className="flex flex-col mb-4">
                        <label>Email</label>
                        <input type="email" required className="shadow-[0_0_4px_0_rgba(0,0,0,0.25)] rounded-[10px] px-4 py-2" ref={emailRef}/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label>Password</label>
                        <input type="password" required className="shadow-[0_0_4px_0_rgba(0,0,0,0.25)] rounded-[10px] px-4 py-2" ref={passwordRef}/>
                    </div>
